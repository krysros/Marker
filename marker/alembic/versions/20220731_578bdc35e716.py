...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['creator_id'], ['users.id'], name='fk_documents_creator_id_users', ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['editor_id'], ['users.id'], name='fk_documents_editor_id_users', ondelete='SET NULL'),
