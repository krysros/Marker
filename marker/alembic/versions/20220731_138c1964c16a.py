...
def upgrade():
    ...
    op.alter_column(table_name='companies', column_name='regon', new_column_name='REGON')
    ...
    op.alter_column(table_name='companies', column_name='voivodeship', new_column_name='state')
...
def downgrade():
    ...
    op.alter_column(table_name='companies', column_name='REGON', new_column_name='regon')
    op.alter_column(table_name='companies', column_name='KRS', new_column_name='krs')
    op.alter_column(table_name='companies', column_name='state', new_column_name='voivodeship')
