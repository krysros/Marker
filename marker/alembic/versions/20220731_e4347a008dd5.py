...
def upgrade():
    op.alter_column(table_name='persons', column_name='fullname', new_column_name='name')

def downgrade():
    op.alter_column(table_name='persons', column_name='name', new_column_name='fullname')
