...
def upgrade():
    ...
    op.create_foreign_key(op.f('fk_recomended_company_id_companies'), 'recomended', 'companies', ['company_id'], ['id'], onupdate='CASCADE', ondelete='CASCADE')
    op.create_foreign_key(op.f('fk_recomended_user_id_users'), 'recomended', 'users', ['user_id'], ['id'], onupdate='CASCADE', ondelete='CASCADE')
...
def downgrade():
    ...
    op.create_foreign_key(op.f('fk_thumbs_up_company_id_companies'), 'thumbs_up', 'companies', ['company_id'], ['id'], onupdate='CASCADE', ondelete='CASCADE')
    op.create_foreign_key(op.f('fk_thumbs_up_user_id_users'), 'thumbs_up', 'users', ['user_id'], ['id'], onupdate='CASCADE', ondelete='CASCADE')
