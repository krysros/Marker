...
def upgrade():
    ...
    op.create_foreign_key(
        op.f("fk_comments_company_id_companies"),
        "comments",
        "companies",
        ["company_id"],
        ["id"],
...
def downgrade():
    op.drop_constraint(
        op.f("fk_persons_project_id_projects"), "persons", type_="foreignkey"
    )
    op.drop_constraint(
        op.f("fk_persons_company_id_companies"), "persons", type_="foreignkey"
    )
    op.drop_column("persons", "project_id")
    op.drop_column("persons", "company_id")
    op.drop_constraint(
        op.f("fk_comments_company_id_companies"), "comments", type_="foreignkey"
    )
    op.drop_constraint(
        op.f("fk_comments_project_id_projects"), "comments", type_="foreignkey"
    )
