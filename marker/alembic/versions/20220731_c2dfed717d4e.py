...
def upgrade():
    op.add_column('projects', sa.Column('street', sa.Unicode(length=100), nullable=True))
    op.add_column('projects', sa.Column('postcode', sa.Unicode(length=10), nullable=True))
    ...
    op.add_column('projects', sa.Column('project_delivery_method', sa.Unicode(length=100), nullable=True))
    op.alter_column(table_name='projects', column_name='voivodeship', new_column_name='state')
...
def downgrade():
    ...
    op.alter_column(table_name='projects', column_name='state', new_column_name='voivodeship')
