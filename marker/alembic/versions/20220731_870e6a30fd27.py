...
def downgrade():
    op.add_column('companies', sa.Column('phone', sa.VARCHAR(length=150), autoincrement=False, nullable=True))
    op.add_column('companies', sa.Column('email', sa.VARCHAR(length=200), autoincrement=False, nullable=True))
