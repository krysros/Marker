...
def upgrade():
    ...
    op.drop_constraint(
        op.f("fk_companies_branches_branch_id_branches"), "companies_branches"
    )
    op.drop_constraint(
        op.f("fk_companies_branches_company_id_companies"), "companies_branches"
    )
    ...
    op.alter_column(
        table_name="companies_tags", column_name="branch_id", new_column_name="tag_id"
    )
    op.create_primary_key("pk_tags", "tags", ["id"])
    op.create_foreign_key(
        op.f("fk_tags_creator_id_users"),
        "tags",
        "users",
        ["creator_id"],
        ["id"],
    ...
    op.create_foreign_key(
        op.f("fk_companies_tags_tag_id_tags"),
        "companies_tags",
        "tags",
        ["tag_id"],
        ["id"],
    ...
    op.create_foreign_key(
        op.f("fk_companies_tags_company_id_companies"),
        "companies_tags",
        "companies",
        ["company_id"],
        ["id"],
...
def downgrade():
    ...
    op.create_foreign_key(
        op.f("fk_branches_creator_id_users"),
        "branches",
        "users",
        ["creator_id"],
        ["id"],
    ...
    op.create_foreign_key(
        op.f("fk_branches_editor_id_users"),
        "branches",
        "users",
        ["editor_id"],
        ["id"],
    ...
    op.create_foreign_key(
        op.f("fk_companies_branches_branch_id_branches"),
        "companies_branches",
        "branches",
        ["branch_id"],
        ["id"],
    ...
    op.create_foreign_key(
        op.f("fk_companies_branches_company_id_companies"),
        "companies_branches",
        "companies",
        ["company_id"],
        ["id"],
