...
class ChangePassword(Form):
    password = PasswordField('Nowe hasło', validators=[InputRequired(), Length(min=5, message="Minimalna długość hasła to %(min)d znaków"), EqualTo('confirm', message='Hasła muszą pasować')])
