  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav me-auto mb-2 mb-md-0">
        <li class="nav-item">
          <a class="nav-link" role="button" href="${request.route_url('company_all')}"><i class="bi bi-building"></i> Firmy</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" role="button" href="${request.route_url('comments')}"><i class="bi bi-chat-left-text"></i> Komentarze</a>
        </li>
        <li class="nav-item">
