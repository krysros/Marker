            ...
            <form hx-post="${request.route_url('add_project', company_id=company.id, slug=company.slug)}" hx-target="#company-projects" hx-swap="innerHTML">
              ...
              <div class="modal-body">
                <div class="mb-3">
                  ...
                  <input list="projects" type="text" class="form-control" id="project-name" name="name" autocomplete="off" hx-get="${request.route_url('project_select')}" hx-target="#project-list" hx-trigger="keyup changed delay:250ms">
                  <div id="project-list">
