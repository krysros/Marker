...
<div class="card">
  <div class="card-body">
    ...
    <div class="float-end">
      <a class="btn btn-primary" role="button" href="#top" hx-get="${request.route_url('project_search')}" hx-target="#main-container">Szukaj</a>
      <a class="btn btn-success" role="button" href="#top" hx-get="${request.route_url('project_add')}" hx-target="#main-container">Dodaj</a>
    </div>
  </div>
</div>
