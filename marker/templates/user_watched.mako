...
<div class="hstack gap-2 mb-4">
  <div>${button.dropdown(dd_filter, url=request.route_url('user_watched', username=user.name))}</div>
  <div>${button.dropdown(dd_sort, url=request.route_url('user_watched', username=user.name))}</div>
  <div class="me-auto">${button.dropdown(dd_order, url=request.route_url('user_watched', username=user.name))}</div>
