...
<form id="user_watched_export" action="${request.route_url('user_watched_export', username=user.name)}" method="post">
...
<div class="card">
  <div class="card-body">
    ...
    <div class="float-end">
      <button type="submit" class="btn btn-primary" form="user_watched_export" value="submit">Eksportuj</button>
