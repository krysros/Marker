...
<div class="hstack gap-2 mb-4">
  ...
  <div>${button.button('user_export_watched', color='primary', icon='download', username=user.name, _query={'filter': dd_filter._filter, 'sort': dd_sort._sort, 'order': dd_order._order})}</div>
</div>
