  ...
  <div class="card-body">
    ...
    <div class="btn-group">
      ...
      <div class="dropdown-menu" aria-labelledby="sortCompanies">
        ...
        <a class="dropdown-item" href="${request.route_url('company_all', _query={'filter': filter, 'sort': 'added'})}">
          % if sort == 'added':
        ...
        <a class="dropdown-item" href="${request.route_url('company_all', _query={'filter': filter, 'sort': 'edited'})}">
          % if sort == 'edited':
