...
<div class="hstack gap-2 mb-4">
  ...
  <div>${button.a_button(icon='download', color='primary', url=request.route_url('tag_export_projects', tag_id=tag.id, slug=tag.slug, _query={'sort': dd_sort._sort, 'order': dd_order._order}))}</div>
</div>
