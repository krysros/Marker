...
<div class="hstack gap-2 mb-4">
  <div class="me-auto">
    <ul class="nav nav-pills">
      ...
      <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="${request.route_url('user_projects', username=user.name)}">Projekty <span class="badge text-bg-secondary">${c_projects}</span></a>
      </li>
      <li class="nav-item">
...
<div class="hstack gap-2 mb-4">
  <div>${dropdown.filter_button('user_projects', dropdown_status, username=user.name)}</div>
