...
<div class="card border-${company.color}">
    ...
    <div class="row">
      ...
      <div class="col-2">
        <div class="float-end">
          ...
          <button id="btn-add-person" type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#add-person-modal">
            Dodaj
          </button>
          % else:
  ...
  <div class="card-body">
    <p>Osoby do kontaktu w firmie <strong>${company.name}</strong></p>
  </div>
</div>
