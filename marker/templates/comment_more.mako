...
% endif
  <div class="card-header">
    ...
    <span style="float:right;"><a class="btn btn-danger btn-sm" role="button" hx-get="${request.route_url('comment_delete', comment_id=comment.id)}" hx-target="#main-container">Usuń</a></span>
    % endif
  </div>
  <div class="card-body">
    <p>${comment.comment}</p>
