...
<div class="hstack gap-2 mb-4">
  <div class="me-auto">
    <ul class="nav nav-pills">
      ...
      <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="${request.route_url('user_companies', username=user.name)}">Firmy <span class="badge text-bg-secondary">${user.count_companies}</span></a>
      </li>
      <li class="nav-item">
