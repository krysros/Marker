...
<form id="user_recomended_export" action="${request.route_url('user_recomended_export', username=user.name)}" method="post">
...
<div class="card">
  <div class="card-body">
    ...
    <div class="float-end">
      <button type="submit" class="btn btn-primary" form="user_recomended_export" value="submit">Eksportuj</button>
