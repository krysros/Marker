...
<div class="card border-${company.color}">
  <div class="card-header">
    <div class="row">
      ...
      <div class="col-2">
        <div class="float-end">
          <button class="btn btn-primary btn-sm" hx-post="${request.route_url('company_recommend', company_id=company.id)}" hx-headers='{"X-CSRF-Token": "${get_csrf_token()}"}' hx-target="#recomended">
            <div id="recomended">
