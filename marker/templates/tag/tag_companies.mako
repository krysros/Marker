...
<div class="hstack gap-2 mb-4 d-flex flex-wrap">
  ...
  <div>${button.dropdown_download(url_xlsx=request.route_url('tag_export_companies', tag_id=tag.id, slug=tag.slug, _query=q), url_ods=request.route_url('tag_export_companies', tag_id=tag.id, slug=tag.slug, _query={**q, 'format': 'ods'}))}</div>
  <div>
