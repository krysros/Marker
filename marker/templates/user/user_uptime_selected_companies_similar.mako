...
<div class="d-flex flex-wrap align-items-center gap-2 mb-4 pb-1">
  ...
  ${button.dropdown_quality(
    uptime_url=request.route_url('user_uptime_selected_companies_similar', username=user.name, _query=q),
    duplicates_url=request.route_url('user_selected_companies_similar', username=user.name, _query={**q, 'duplicates': '1', 'no_location': None}),
    nolocation_url=request.route_url('user_selected_companies_similar', username=user.name, _query={**q, 'duplicates': None, 'no_location': '1'}),
    is_uptime=matched_route_name == 'user_uptime_selected_companies_similar',
