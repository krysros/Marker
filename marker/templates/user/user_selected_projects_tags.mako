...
<h2>
  <i class="bi bi-tags"></i> ${_("Tags of selected projects")}
...
<div class="d-flex flex-wrap align-items-center gap-2 mb-4 pb-1">
  ...
  <div class="btn-group btn-group-sm" role="group" aria-label="${_('View mode')}">
    <a class="btn btn-primary" href="${request.route_url('user_selected_projects_tags', username=user.name, _query=q)}"><i class="bi bi-tags"></i> ${_("Tags")}</a>
