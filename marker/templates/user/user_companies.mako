...
<div class="hstack gap-2 mb-4 d-flex flex-wrap">
  ...
  <div>${button.dropdown_download(url_xlsx=request.route_url('user_export_companies', username=user.name, _query=q), url_ods=request.route_url('user_export_companies', username=user.name, _query={**q, 'format': 'ods'}))}</div>
