...
<div class="d-flex flex-wrap align-items-center gap-2 mb-4 pb-1">
  ...
  <div class="vr mx-1"></div>
  <div class="btn-group btn-group-sm" role="group" aria-label="${_('View mode')}" hx-boost="false">
    <a class="btn ${'btn-primary' if matched_route_name == 'user_uptime_selected_companies' else 'btn-outline-primary'}" href="${request.route_url('user_uptime_selected_companies', username=user.name, _query=q)}"><i class="bi bi-globe"></i> ${_("Uptime")}</a>
