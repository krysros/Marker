...
<div class="hstack gap-2 mb-4">
  <div class="me-auto">
    <ul class="nav nav-pills">
      ...
      <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="${request.route_url('user_comments', username=user.name)}">Komentarze <span class="badge text-bg-secondary">${user.count_comments}</span></a>
      </li>
    </ul>
  </div>
</div>
