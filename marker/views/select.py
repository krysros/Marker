...
REPORTS = [
    ...
    ("tv", "Województwa o największej liczbie przetargów"),
    ("tc", "Miasta o największej liczbie przetargów"),
    ("uc", "Aktywność użytkowników (dodane firmy)"),
    ("ut", "Aktywność użytkowników (dodane przetargi)"),
    ("ct", "Inwestorzy (liczba przetargów)"),
    ("cu", "Rekomendowane firmy"),
    ("tf", "Obserwowane przetargi"),
]
