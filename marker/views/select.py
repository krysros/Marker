...
REPORTS = [
    ("cb", "Branże o największej liczbie firm"),
    ("cv", "Województwa o największej liczbie firm"),
    ("cc", "Miasta o największej liczbie firm"),
    ("tv", "Województwa o największej liczbie inwestycji"),
    ("tc", "Miasta o największej liczbie inwestycji"),
    ("uc", "Aktywność użytkowników (dodane firmy)"),
    ("ut", "Aktywność użytkowników (dodane inwestycje)"),
    ("ct", "Inwestorzy (liczba inwestycji)"),
    ("cu", "Rekomendowane firmy"),
    ("tf", "Obserwowane inwestycje"),
]
