...
def includeme(config):
    ...
    config.add_route(
        "company_uptime_rows", "/company/uptime/rows", factory=default_factory
    )
    ...
    config.add_route(
        "project_uptime_rows", "/project/uptime/rows", factory=default_factory
    )
    ...
    config.add_route("report_ai_dashboard", "/report/ai", factory=default_factory)
    ...
    config.add_route(
        "user_selected_companies_similar",
        "/user/{username}/selected_companies/similar",
        factory=user_factory,
    )
    config.add_route(
        "user_more_selected_companies_similar",
        "/user/{username}/more_selected_companies_similar",
        factory=user_factory,
    )
    config.add_route(
        "user_json_selected_companies_similar",
        "/user/{username}/json_selected_companies_similar",
        factory=user_factory,
    )
    config.add_route(
        "user_map_selected_companies_similar",
        "/user/{username}/map_selected_companies_similar",
        factory=user_factory,
    )
    config.add_route(
    ...
    config.add_route(
        "user_delete_selected_companies",
        "/user/{username}/delete_selected_companies",
        factory=user_factory,
    )
    config.add_route(
    ...
    config.add_route(
        "user_selected_projects_similar",
        "/user/{username}/selected_projects/similar",
        factory=user_factory,
    )
    config.add_route(
        "user_more_selected_projects_similar",
        "/user/{username}/more_selected_projects_similar",
        factory=user_factory,
    )
    config.add_route(
        "user_json_selected_projects_similar",
        "/user/{username}/json_selected_projects_similar",
        factory=user_factory,
    )
    config.add_route(
        "user_map_selected_projects_similar",
        "/user/{username}/map_selected_projects_similar",
        factory=user_factory,
    )
    config.add_route(
    ...
    config.add_route(
        "user_delete_selected_tags",
        "/user/{username}/delete_selected_tags",
        factory=user_factory,
    )
    config.add_route(
        "user_deselect_tags",
