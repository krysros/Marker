...
def includeme(config):
    ...
    config.add_route("company_add_from_search", "/company/add_from_search", factory=default_factory)
    ...
    config.add_route("project_add_from_search", "/project/add_from_search", factory=default_factory)
